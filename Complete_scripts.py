...
if __name__ == "__main__":
    ...
    content_image = load_image(args.content_image) #original images without crop
    style_image = load_image(args.style_image)
    print('enterrrrrr cropping')
    cropped_image = face_detection(args.content_image, 'content')
    cropped_style = face_detection(args.style_image, 'style')
    print('enterrrrrr segmntation')
