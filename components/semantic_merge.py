...
def merge_segments(content_segmentation, style_segmentation):
    ...
    if (5,5,5) in set(content_segmentation.keys()).difference(common_keys) and (4,4,4) in set(style_segmentation.keys):
        style_segmentation[(5,5,5)] = style_segmentation[(4,4,4)]
    if (4,4,4) in set(content_segmentation.keys()).difference(common_keys) and (5,5,5) in set(style_segmentation.keys):
    ...
    # present eye inside the style image as a virtual second eye to be transferred on the content image
